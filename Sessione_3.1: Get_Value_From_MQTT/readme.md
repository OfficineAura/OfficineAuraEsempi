...
2. Installa la libreria `paho-mqtt` eseguendo il comando:   'pip install paho-mqtt' su entrambi i sistemi.
...
2. Cambia i diritti del file 'chmod +x aura_mqtt.sh'
3. In Windows puoi utilizzare [Cygwin](https://www.cygwin.com/).
